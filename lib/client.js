...
var Client = function(host){
	 ...
	 * @param {Function} done
	 */
	this.getJson = function(accessToken, url, done){
	 ...
	 * @param {Function} done
	 */
	this.postJson = function(accessToken, url, data, done){
	 ...
	 * @param {Function} done
	 */
	this.patchJson = function(accessToken, url, data, done){
	 ...
	 * @param {Function} done
	 */
	this.putJson = function(accessToken, url, data, done){
	 ...
	 * @param {Function} done
	 */
	this.deleteJson = function(accessToken, url, done){
		makeRequest(true, 'DELETE', url, null, {
			'Authorization': 'Bearer ' + accessToken
		}, done);
	};
	...
	this.post = function(url, data, done){
		makeRequest(false, 'POST', url, data, done);
	};
	 ...
	 * @return {String}
	 */
	this.createUrl = function(url, params, query){
		if (!!params) {
